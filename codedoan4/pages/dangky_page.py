...
# #         #Ưu tiên:Thông báo lỗi, Thông báo thành công, Độ mạnh mật khẩu.
# #         # Thông báo lỗi
# #         try:
...
#         """
#         Ưu tiên:
#         - Nếu nút Đăng ký bị disable => chỉ lấy thông báo độ mạnh mật khẩu.
#         - Nếu nút có thể bấm => lấy thông báo lỗi hoặc thành công.
#         """
...
# 1        return "Không tìm thấy thông báo"
# from selenium.webdriver.common.by import By
# from selenium.common.exceptions import TimeoutException, NoSuchElementException
# from selenium.webdriver.support import expected_conditions as EC
# from base.base_page import BasePage
...
#         Dùng cho các lỗi kiểu: 'Please fill out this field', 'Please include an "@" in the email address'...
#         """
...
class TrangDangKy(BasePage):
    ...
    def lay_thong_bao(self, timeout=10):
        """
        Thứ tự ưu tiên:
        1️⃣ Nếu có thông báo HTML5 → trả về ngay.
        2️⃣ Nếu nút Đăng ký bị disable → chỉ lấy thông báo độ mạnh mật khẩu.
        3️⃣ Nếu nút enable → lấy lỗi hoặc thành công.
        """

        # --- 1️⃣ Kiểm tra thông báo HTML5 trước ---
        msg_html5 = self.lay_thong_bao_html5()
        if msg_html5:
            return msg_html5

        # --- 2️⃣ Kiểm tra trạng thái nút Đăng ký ---
        try:
            btn = self.driver.find_element(*self.BTN_DANGKY)
            nut_disable = not btn.is_enabled()
        except NoSuchElementException:
